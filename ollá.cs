...
public static class Arrays
{
    ...
    public static double[] MultiplesOf(double number, int length)
    {
        ...
        // 4. Assign the calculated value to the current index in the 'results' array.
        // 5. Return the completed 'results' array.
    ...
    {
        // --- PLAN ---
        // 1. Check if the list has data and the amount is greater than 0 to avoid errors.
        // 2. Determine the starting position of the slice by subtracting 'amount' from the total count.
        // 3. Use GetRange to capture the last 'amount' elements from the list into a temporary list.
        // 4. Remove those same elements from their original position at the end of the list using RemoveRange.
        // 5. Insert the temporary list at the beginning (index 0) of the original list using InsertRange.
